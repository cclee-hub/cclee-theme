...
| JS handle | `cclee-` | `cclee-theme-js` |
...
| Header Account & Cart | `cclee-theme/header-account-cart` | cclee-theme, header | 页头账户图标 + 购物车图标 |
| Header Search | `cclee-theme/header-search` | cclee-theme, header | 页头搜索按钮/表单 |
| Header Social Links | `cclee-theme/header-social` | cclee-theme, header | 页头社交链接图标 |
| Breadcrumb | `cclee-theme/breadcrumb` | cclee-theme, navigation | 面包屑导航 + 结果计数 |
| Page Header | `cclee-theme/page-header` | cclee-theme, featured | 通用页面标题头（标题 + 更新日期） |
| View Toggle | `cclee-theme/view-toggle` | cclee-theme, woocommerce | 网格/列表视图切换按钮 |
...
| WooCommerce Account User Info | `cclee-theme/woo-account-user-info` | cclee-theme, woocommerce | 账户页用户信息卡片（头像 + 欢迎语 + 角色） |
