...
add_action( 'admin_init', function () {
	register_setting( 'cclee_theme_options', 'cclee_ai_api_key', [
		'type'              => 'string',
		'sanitize_callback' => 'sanitize_text_field',
		'show_in_rest'      => false, // 安全：不暴露到 REST API
	] );

	register_setting( 'cclee_theme_options', 'cclee_ai_enabled', [
		'type'              => 'boolean',
...
add_action( 'admin_menu', function () {
	add_theme_page(
		...
		function () {
			?>
			<div class="wrap">
				<h1>CCLEE AI Assistant Settings</h1>
				<form method="post" action="options.php">
					<?php
					settings_fields( 'cclee_theme_options' );
					do_settings_sections( 'cclee_theme_options' );
					?>
							...
							<td>
								<label>
									<input type="checkbox"
										   ...
										   value="1"
										<?php checked( get_option( 'cclee_ai_enabled', false ) ); ?>>
						...
						<tr>
							...
							<td>
								<input type="password"
									   ...
									   value="<?php echo esc_attr( get_option( 'cclee_ai_api_key', '' ) ); ?>"
									   class="regular-text">
