...
<div class="wp-block-group alignfull has-accent-gradient-background has-primary-color has-text-color has-background cclee-cta-banner" style="padding-top:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--80)">
	...
	<div class="wp-block-group">
		...
		<!-- wp:paragraph {"align":"center","textColor":"primary","fontSize":"x-large","style":{"spacing":{"margin":{"top":"var(--wp--preset--spacing--30)","bottom":"var(--wp--preset--spacing--50)"}}}} -->
		<p class="has-text-align-center has-primary-color has-text-color has-x-large-font-size" style="margin-top:var(--wp--preset--spacing--30);margin-bottom:var(--wp--preset--spacing--50)">Join thousands of users building with CCLEE Theme.</p>
		<!-- /wp:paragraph -->
