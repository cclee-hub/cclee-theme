...
<div class="wp-block-cover alignfull has-base-color has-contrast-background-color has-text-color has-background" style="padding-top:var(--wp--preset--spacing--80);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--80);padding-left:var(--wp--preset--spacing--50);min-height:480px">
	...
	<div class="wp-block-cover__inner-container">
		...
		<p class="has-text-align-center has-neutral-100-color has-text-color has-medium-font-size cclee-text--label">Welcome to CCLEE</p>
		<!-- /wp:paragraph -->

		<!-- wp:heading {"textAlign":"center","level":1,"fontSize":"heading-1","textColor":"base"} -->
		<h1 class="wp-block-heading has-text-align-center has-base-color has-text-color has-heading-1-font-size">Build Something Beautiful</h1>
		<!-- /wp:heading -->

		<!-- wp:paragraph {"align":"center","fontSize":"xx-large","textColor":"neutral-200"} -->
		<p class="has-text-align-center has-neutral-200-color has-text-color has-xx-large-font-size">Streamline your operations and accelerate growth with integrated solutions designed for modern businesses.</p>
		<!-- /wp:paragraph -->
