...
<div class="wp-block-group alignfull has-surface-background-color has-base-color has-text-color has-background" style="padding-top:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--80)">
	...
	<!-- wp:columns {"className":"is-style-equal-height","style":{"spacing":{"margin":{"top":"var(--wp--preset--spacing--60)"}}} -->
	<div class="wp-block-columns is-style-equal-height" style="margin-top:var(--wp--preset--spacing--60)">

		<!-- wp:column -->
		<div class="wp-block-column">
			<!-- wp:group {"className":"cclee-pricing-card","style":{"spacing":{"padding":{"top":"var(--wp--preset--spacing--50)","right":"var(--wp--preset--spacing--40)","bottom":"var(--wp--preset--spacing--50)","left":"var(--wp--preset--spacing--40)"}},"border":{"radius":"var(--wp--custom--border--radius--lg)","width":"1px","style":"solid"}},"borderColor":"neutral-200","backgroundColor":"base","layout":{"type":"flex","orientation":"vertical","flexWrap":"nowrap"}} -->
			<div class="wp-block-group cclee-pricing-card has-border-color has-neutral-200-border-color has-base-background-color has-background" style="border-style:solid;border-width:1px;border-radius:var(--wp--custom--border--radius--lg);padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--40)">

				<!-- wp:heading {"textAlign":"center","level":4,"textColor":"primary","fontSize":"heading-4","className":"cclee-card"} -->
				<h4 class="wp-block-heading has-text-align-center has-primary-color has-text-color has-heading-4-font-size cclee-card">Starter</h4>
				<!-- /wp:heading -->
				...
				<!-- wp:html -->
				<ul class="cclee-check-list has-primary-color has-text-color">
				...
				<!-- wp:buttons {"layout":{"type":"flex","justifyContent":"stretch"},"style":{"width":"100%"}} -->
		...
		<!-- wp:column -->
		<div class="wp-block-column">
			<!-- wp:group {"className":"cclee-pricing-card","style":{"spacing":{"padding":{"top":"var(--wp--preset--spacing--50)","right":"var(--wp--preset--spacing--40)","bottom":"var(--wp--preset--spacing--50)","left":"var(--wp--preset--spacing--40)"}},"border":{"radius":"var(--wp--custom--border--radius--lg)"}},"gradient":"accent","textColor":"base","layout":{"type":"flex","orientation":"vertical","flexWrap":"nowrap"}} -->
			<div class="wp-block-group cclee-pricing-card has-base-color has-text-color has-accent-gradient-background has-background" style="border-radius:var(--wp--custom--border--radius--lg);padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--40)">

				<!-- wp:heading {"textAlign":"center","level":4,"fontSize":"heading-4","className":"cclee-card"} -->
				<h4 class="wp-block-heading has-text-align-center has-heading-4-font-size cclee-card">Pro</h4>
				<!-- /wp:heading -->
				...
				<!-- wp:html -->
				<ul class="cclee-check-list has-base-color has-text-color">
				...
				<div class="wp-block-buttons">
					...
					<div class="wp-block-button is-style-outline has-custom-width wp-block-button__width-100"><a class="wp-block-button__link wp-element-button">Start Free Trial</a></div>
					<!-- /wp:button -->
				</div>
				<!-- /wp:buttons -->
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group cclee-pricing-card has-border-color has-neutral-200-border-color has-base-background-color has-background" style="border-style:solid;border-width:1px;border-radius:var(--wp--custom--border--radius--lg);padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--40)">
				...
				<!-- wp:heading {"textAlign":"center","level":4,"textColor":"primary","fontSize":"heading-4","className":"cclee-card"} -->
				<h4 class="wp-block-heading has-text-align-center has-primary-color has-text-color has-heading-4-font-size cclee-card">Enterprise</h4>
				<!-- /wp:heading -->
