	...
	<div class="wp-block-group alignwide">
		...
		<div class="wp-block-columns is-not-stacked-on-mobile is-style-equal-height">
			...
			<div class="wp-block-column" style="flex-basis:25%">
				<!-- wp:group {"style":{"spacing":{"padding":{"top":"var(--wp--preset--spacing--50)","bottom":"var(--wp--preset--spacing--50)","left":"var(--wp--preset--spacing--40)","right":"var(--wp--preset--spacing--40)"}},"border":{"radius":"12px"}},"backgroundColor":"neutral-100","layout":{"type":"flex","orientation":"vertical","justifyContent":"center"}} -->
				<div class="wp-block-group has-neutral-100-background-color has-background" style="border-radius:12px;padding-top:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--40);padding-right:var(--wp--preset--spacing--40)">
					...
					<p class="has-text-align-center has-neutral-300-color has-text-color" style="text-transform:uppercase;letter-spacing:0.1em;margin-top:var(--wp--preset--spacing--20)">Projects Delivered</p>
					<!-- /wp:paragraph -->
			...
			<div class="wp-block-column" style="flex-basis:25%">
				...
				<div class="wp-block-group has-neutral-100-background-color has-background" style="border-radius:12px;padding-top:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--40);padding-right:var(--wp--preset--spacing--40)">
					...
					<!-- wp:paragraph {"align":"center","textColor":"neutral-300","style":{"typography":{"textTransform":"uppercase","letterSpacing":"0.1em"},"spacing":{"margin":{"top":"var(--wp--preset--spacing--20)"}}}} -->
					<p class="has-text-align-center has-neutral-300-color has-text-color" style="text-transform:uppercase;letter-spacing:0.1em;margin-top:var(--wp--preset--spacing--20)">Client Satisfaction</p>
					<!-- /wp:paragraph -->
			...
			<div class="wp-block-column" style="flex-basis:25%">
				...
				<div class="wp-block-group has-neutral-100-background-color has-background" style="border-radius:12px;padding-top:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--40);padding-right:var(--wp--preset--spacing--40)">
					...
					<!-- wp:paragraph {"align":"center","textColor":"neutral-300","style":{"typography":{"textTransform":"uppercase","letterSpacing":"0.1em"},"spacing":{"margin":{"top":"var(--wp--preset--spacing--20)"}}}} -->
					<p class="has-text-align-center has-neutral-300-color has-text-color" style="text-transform:uppercase;letter-spacing:0.1em;margin-top:var(--wp--preset--spacing--20)">Support Available</p>
					<!-- /wp:paragraph -->
