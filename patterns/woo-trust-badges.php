...
<div class="wp-block-group woo-trust-badges" style="display:flex;flex-wrap:wrap;justify-content:center;gap:var(--wp--preset--spacing--30);margin-top:var(--wp--preset--spacing--40)">
	...
	<!-- wp:group {"className":"woo-trust-badge","layout":{"type":"flex"}} -->
	<div class="wp-block-group woo-trust-badge" style="display:flex;align-items:center;gap:var(--wp--preset--spacing--10)">
		<!-- wp:html -->
