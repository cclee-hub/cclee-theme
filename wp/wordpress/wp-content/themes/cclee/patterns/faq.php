...
<div class="wp-block-group alignwide has-neutral-50-background-color has-background" style="padding-top:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--70)">
	...
	<div class="wp-block-group" style="padding-right:var(--wp--preset--spacing--40);padding-left:var(--wp--preset--spacing--40)">
		...
		<!-- wp:details {"style":{"spacing":{"margin":{"bottom":"var(--wp--preset--spacing--20)"}},"border":{"radius":"var(--wp--custom--border--radius--md)","width":"1px","style":"solid"}},"borderColor":"neutral-200","backgroundColor":"base"} -->
		...
		<!-- wp:details {"style":{"border":{"radius":"var(--wp--custom--border--radius--md)","width":"1px","style":"solid"}},"borderColor":"neutral-200","backgroundColor":"base"} -->
